...
public:
	...
	static Mesh generateMeshFromTriangles(const std::vector<Triangle> &triangles, bool hasTexCoords = false);
	static Mesh generateMeshFromVerts(const std::vector<Vertex> &verts, bool hasTexCoords = false);
